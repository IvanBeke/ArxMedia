...
def repair_tv_progress(apps, schema_editor):
    ...
    statuses = UserMediaStatus.objects.filter(media_type='tv').exclude(status='plan_to_watch')
...
class Migration(migrations.Migration):
    dependencies = [  # noqa: RUF012
        ('tracking', '0025_remove_usermediastatus_next_episode'),
    ]

    operations = [migrations.RunPython(repair_tv_progress, migrations.RunPython.noop)]  # noqa: RUF012
