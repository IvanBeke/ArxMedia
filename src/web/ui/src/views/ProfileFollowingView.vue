  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <template v-else>
      ...
      <div v-else-if="following.length" class="space-y-3">
        <div v-for="user in following" :key="`following-${user.id}`" class="card p-4 md:p-5 flex items-center justify-between gap-4 hover:bg-surface-200/40 transition-colors">
