...
const messages = {
  en: {
    ...
    watch_option_unknown: 'Unknown date',
    ...
    remove_history_confirm_show: 'This will remove all episodes of this show from your history, are you sure?',
    remove_history_confirm_movie: 'This will remove the movie from your history, are you sure?',
    remove_history_confirm_episode: 'This will remove the episode from your history, are you sure?',
    ...
    pwa_offline_banner: 'You are offline. Content may be outdated.',
    pwa_offline_title: 'You are offline',
    pwa_offline_desc: 'ArxMedia needs a connection to load your library. Cached pages still work — try again when you are back online.',
    pwa_offline_retry: 'Retry',
    pwa_update_title: 'Update available',
    pwa_update_desc: 'A new version of ArxMedia is ready.',
    pwa_update_action: 'Update now',
    pwa_update_dismiss: 'Later',
    pwa_install_title: 'Install ArxMedia',
    pwa_install_desc: 'Add it to your home screen for quick access and offline support.',
    pwa_install_action: 'Install',
    pwa_install_dismiss: 'Not now',
    pwa_settings_title: 'Offline & updates',
    pwa_settings_ready: 'Ready for offline use.',
    pwa_settings_not_ready: 'Offline support activates after the app finishes loading once.',
    pwa_settings_install: 'Install app',
    pwa_settings_update: 'Update to the latest version',
  },
  es: {
    nav_dashboard: 'Panel',
    ...
    settings_spoiler_mode_desc: 'Difumina imágenes y descripciones no vistas hasta revelarlas.',
    ...
    nav_open_search: 'Abrir búsqueda',
    nav_open_user_menu: 'Abrir menú de usuario',
    ...
    watch_option_unknown: 'Fecha desconocida',
    ...
    remove_history_confirm_show: 'Esto eliminara todos los episodios de esta serie de tu historial, ¿estás seguro?',
    remove_history_confirm_movie: 'Esto eliminara la pelicula de tu historial, ¿estás seguro?',
    remove_history_confirm_episode: 'Esto eliminara el episodio de tu historial, ¿estás seguro?',
    ...
    profile_empty_followers: 'Aún no tiene seguidores.',
    profile_empty_following: 'Aún no sigue a nadie.',
    profile_about_joined: 'Se unio',
    profile_about_location: 'Ubicación',
    ...
    pwa_offline_banner: 'Sin conexión. El contenido puede estar desactualizado.',
    pwa_offline_title: 'Sin conexión',
    pwa_offline_desc: 'ArxMedia necesita conexión para cargar tu biblioteca. Las páginas en caché siguen funcionando; inténtalo de nuevo cuando vuelvas a estar en línea.',
    pwa_offline_retry: 'Reintentar',
    pwa_update_title: 'Actualización disponible',
    pwa_update_desc: 'Hay una nueva versión de ArxMedia lista.',
    pwa_update_action: 'Actualizar ahora',
    pwa_update_dismiss: 'Más tarde',
    pwa_install_title: 'Instalar ArxMedia',
    pwa_install_desc: 'Añádela a tu pantalla de inicio para acceso rápido y soporte sin conexión.',
    pwa_install_action: 'Instalar',
    pwa_install_dismiss: 'Ahora no',
    pwa_settings_title: 'Sin conexión y actualizaciones',
    pwa_settings_ready: 'Listo para funcionar sin conexión.',
    pwa_settings_not_ready: 'El soporte sin conexión se activa cuando la app termina de cargar una vez.',
    pwa_settings_install: 'Instalar app',
    pwa_settings_update: 'Actualizar a la última versión',
  }
}
...
export function useI18n() {
  ...
  const t = (key: MessageKey, params: MessageParams = {}): string => {
    const localeMessages = locale.value === 'es' ? messages.es : messages.en
...
export function formatDateByLocale(value: unknown): string {
  if (!value) return ''
  const prefs = usePreferencesStore()
