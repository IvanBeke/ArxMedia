...
export interface CollectionSummary { id: number; name: string; poster_path?: string | null; backdrop_path?: string | null }
export interface CollectionDetail extends CollectionSummary { overview: string; poster_url?: string | null; backdrop_url?: string | null; parts: MediaResult[] }
export interface Movie extends MediaResult { title: string; tmdb_id: number; genres: Genre[]; poster_url: string | null; backdrop_url: string | null; runtime: number | null; language: string; tagline: string; status: string; metadata_updated_at: string; watch_providers?: WatchProviders; collection?: CollectionSummary | null; external_ids?: ExternalIds }
export interface Episode { id: number; tmdb_id: number; episode_number: number; name: string; overview: string; still_path: string | null; still_url: string | null; air_date: string | null; air_time: string | null; broadcast_start: string | null; runtime: number | null; vote_average: number; vote_count: number; episode_type: string; cast?: Person[]; guest_stars: Person[]; crew: Person[] }
export interface SeasonBrief { id: number; season_number: number; name: string; overview?: string; poster_path: string | null; poster_url: string | null; air_date: string | null; episode_count: number; vote_average?: number; vote_count?: number }
export interface SeasonProgress { watched_episodes?: number }
export interface Season extends SeasonBrief { tmdb_id: number; overview: string; episodes: Episode[]; show_name?: string; vote_average?: number; vote_count?: number; credits?: Credits; external_ids?: ExternalIds; user_status?: MediaUserStatus & { progress?: SeasonProgress } }
export interface TVShow extends MediaResult { name: string; tmdb_id: number; genres: Genre[]; poster_url: string | null; backdrop_url: string | null; first_air_date: string | null; last_air_date: string | null; number_of_seasons: number; number_of_episodes: number; language: string; status: string; networks: string[]; episode_runtime: number | null; metadata_updated_at: string; seasons: SeasonBrief[]; watch_providers?: WatchProviders; external_ids?: ExternalIds }
export interface WatchEntry { id: number; media_type: WatchEntryMediaType; tmdb_id: number; watched_at: string; season_number: number | null; episode_number: number | null; created_at: string; title: string; poster_path: string | null; poster_url: string | null; vote_average: number; show_name: string | null; episode_type: string; rating?: number | null }
