...
export interface SeasonBrief { id: number; season_number: number; name: string; overview?: string; poster_path: string | null; poster_url: string | null; air_date: string | null; episode_count: number }
export interface SeasonProgress { watched_episodes?: number }
export interface Season extends SeasonBrief { tmdb_id: number; overview: string; episodes: Episode[]; show_name?: string; credits?: Credits; external_ids?: ExternalIds; user_status?: MediaUserStatus & { progress?: SeasonProgress } }
